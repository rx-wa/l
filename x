  ...
  onStart() {
      ...
      if (sheet === "MessageLongPressActionSheet") {
        component.then((instance: any) => {
          ...
          instance.default = function (
            ...
            const ButtonRow = og.props.children.props.children.props.children[1][0].type;
    ...
    Patcher.before(Messages, "editMessage", (_a0, a1, _a2) => {
      if (dirtyEdit) {
        ...
        a1[0] = {} as any;  // Note: Updated this line to assign to a1[0] instead of creating a new object
      }
    });
